...
# get fluxnet data for FR-Pue site
df <- read_csv("~/data_2/FluxDataKit/v3.4/zenodo_upload/fluxnet/FLX_US-Var_FLUXDATAKIT_FULLSET_DD_2000_2021_2-3.csv") |>
  select(TIMESTAMP, P_F, TA_F_MDS, PA_F, LE_F_MDS, SW_IN_F_MDS, LW_IN_F_MDS, NETRAD)

# visdat::vis_miss(df)

saveRDS(df, file = paste0(here(), "/data/df_US-Var.rds"))
